...
function OutformCard({ id, items }) {
  return (
    <Link to={`/outform/${id}`} className="block hover:scale-105 transform transition duration-300">
      <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-md hover:shadow-lg">
        {/* OutForm Info */}
        <h3 className="text-lg font-bold text-gray-800 mb-3">Out Form Details</h3>
